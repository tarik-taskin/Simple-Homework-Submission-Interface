...
function Odevler() {
  return (
    <div className='odevler'>
        <h3>Ödevler</h3>
        <Odev odevad={"Aydın Kimya - Asit ve Bazlar"} odevsuresi={2} odevtarihi={"4/03/2025"} ogretmenad={"Hülya Ersoy"}/>
        <Odev odevad={"3D Matematik - Polinomlar"} odevsuresi={3} odevtarihi={"5/03/2025"} ogretmenad={"Hülya Ersoy"}/>
